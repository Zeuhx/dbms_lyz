...
public class BufferManager {
	...
	public int searchFrame(PageId pageId) {
		...
		return (2); // Pour retourner l'index de la frame concernï¿½ retourne 2 si pas trouvï¿½
	}
	...
	/**
	 * 
	 * Cette mÃ©thode devra dÃ©crÃ©menter le pin_count et actualiser le flag dirty de
	 * la page.
	 * 
	 * @param pageId
	 * @param valdirty
	...
	public void freePage(PageId pageId, boolean valdirty) {
		int indexFrame = searchFrame(pageId);
		if (indexFrame == 2)
			System.out.println("Frame Pas trouvï¿½");
		else {
			f = listFrame.get(indexFrame);
			f.free(valdirty);
		}
	 ...
	 * A FAIRE !!
	 * 
	 * Cette mÃ©thode sâ€™occupe de : â—¦ lâ€™Ã©criture de toutes les pages dont le flag
	 * dirty = 1 sur disque â—¦ la remise Ã  0 de tous les flags/informations et
	 * contenus des buffers (buffer pool Â« vide Â»)
	 */
	...
	// Une mï¿½thode pour modfif les pages qui sont dans les frames
