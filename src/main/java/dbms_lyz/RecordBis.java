...
/**
 * ATTENTION CLASSE BIS (VERSION DE TEST INTEGRE A LA VERSION NORMAL DEJA) 
 * @author Cedric
 *
 */
public class RecordBis {
	 ...
	 * 
	 * Ecrit les valeurs du Record dans le buffer, l’une après l’autre, à partir de
	 * position
	 * 
	 * @param buff     un buffer
	 * @param position , la position dans le buffer
	 * 
	 *                 On prend la classe de la case i, on verifie si elle est bien
	 *                 presente Et on inject caractere par caratere dans le buffer
	 */
